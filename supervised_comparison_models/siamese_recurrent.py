...
if __name__ == '__main__':
  ...
  X_train = preprocess_x_data(X_train,2)
  X_test = preprocess_x_data(X_test,2)
  ...
  t_model = get_tower_model(img_shape)
  ...
  n_batches_per_epoch = tr_pair_idxs.shape[0]/batch_size/600
